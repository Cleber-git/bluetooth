...
public:
    ...
    void setupUi(QWidget *screenOfConnect)
    {
        ...
        pushButton->setGeometry(QRect(270, 385, 51, 21));
...
"background: rgb(255, 255, 255);"));
        listWidget = new QListWidget(screenOfConnect);
        listWidget->setObjectName("listWidget");
        listWidget->setGeometry(QRect(70, 91, 256, 251));
        lineEdit = new QLineEdit(screenOfConnect);
        lineEdit->setObjectName("lineEdit");
        lineEdit->setGeometry(QRect(140, 380, 113, 28));
        label_3 = new QLabel(screenOfConnect);
        label_3->setObjectName("label_3");
        label_3->setGeometry(QRect(60, 385, 71, 20));
    ...
    void retranslateUi(QWidget *screenOfConnect)
    {
        ...
        pushButton->setText(QCoreApplication::translate("screenOfConnect", "Push", nullptr));
        ...
        label_3->setText(QCoreApplication::translate("screenOfConnect", "input box: ", nullptr));
    } // retranslateUi
